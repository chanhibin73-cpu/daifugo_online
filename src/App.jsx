  ...
  const fetchRankings = async () => {
    ...
    try {
      ...
      list.forEach((user, idx) => {
        ...
        if (user.lastRank === undefined) {
          newLastRank = currentRank;
          newRankTrend = 'same';
          newRankTrendUpdatedAt = now;
          needsUpdate = true;
        } else if (user.lastRank !== currentRank) {
                  ...
                  return (
                    <div key={idx} className={`ranking-item ${user.userId === userData.userId ? 'highlight-me' : ''}`}>
                      <span style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        {user.trend === 'up' && <span style={{ color: '#e74c3c', marginLeft: '6px', fontWeight: 'bold' }}>↑</span>}
                        {user.trend === 'down' && <span style={{ color: '#3498db', marginLeft: '6px', fontWeight: 'bold' }}>↓</span>}
                      </span>
              ...
              <div style={{ marginTop: '10px', paddingTop: '10px', borderTop: '2px dashed #bdc3c7' }}>
                ...
                <div className="ranking-item highlight-me" style={{ margin: '0', borderRadius: '8px' }}>
                  <span style={{ display: 'flex', alignItems: 'center', fontWeight: 'bold' }}>
                    ...
                    {myRankingInfo.user.trend === 'up' && <span style={{ color: '#e74c3c', marginLeft: '6px', fontWeight: 'bold' }}>↑</span>}
                    {myRankingInfo.user.trend === 'down' && <span style={{ color: '#3498db', marginLeft: '6px', fontWeight: 'bold' }}>↓</span>}
                  </span>
