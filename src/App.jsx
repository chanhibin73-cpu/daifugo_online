  ...
  useEffect(() => {
    ...
    const initAIPlayers = async () => {
      const aiPlayers = [
        ...
        { userId: 'ai_player_41', username: 'AI_SAKAMOTO', rating: 2000, maxRating: 2000, wins: [0,0,0,0], totalGames: 0, currentWinStreak: 0, maxWinStreak: 0, isAIPlayer: true, status: 'online' },
      ];
      let needsInit = false;
