                  ...
                  return (
                    <div key={idx} className={`ranking-item ${user.userId === userData.userId ? 'highlight-me' : ''}`}>
                      <span style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        {user.trend === 'up' && <span style={{ color: '#e74c3c', marginLeft: '6px', fontWeight: 'bold' }}>↑ {user.trendDiff}</span>}
                        {user.trend === 'down' && <span style={{ color: '#3498db', marginLeft: '6px', fontWeight: 'bold' }}>↓ {user.trendDiff}</span>}
                      </span>
              ...
              <div style={{ marginTop: '10px', paddingTop: '10px', borderTop: '2px dashed #bdc3c7' }}>
                ...
                <div className="ranking-item highlight-me" style={{ margin: '0', borderRadius: '8px' }}>
                  <span style={{ display: 'flex', alignItems: 'center', fontWeight: 'bold' }}>
                    ...
                    {myRankingInfo.user.trend === 'up' && <span style={{ color: '#e74c3c', marginLeft: '6px', fontWeight: 'bold' }}>↑ {myRankingInfo.user.trendDiff}</span>}
                    {myRankingInfo.user.trend === 'down' && <span style={{ color: '#3498db', marginLeft: '6px', fontWeight: 'bold' }}>↓ {myRankingInfo.user.trendDiff}</span>}
                  </span>
