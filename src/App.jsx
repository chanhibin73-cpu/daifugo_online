...
// レーティング計算ロジック（Ver3.2: 10試合制も5試合制と同じ計算式に統一）
...
function App() {
  ...
  const [userData, setUserData] = useState(() => {
    ...
    if (saved) {
      try {
        ...
        // ★ Ver3.2 レーティングの分離マイグレーション
        if (parsed.rating !== undefined) {
          parsed.rating5 = typeof parsed.rating === 'number' && !isNaN(parsed.rating) ? parsed.rating : 500;
          parsed.maxRating5 = typeof parsed.maxRating === 'number' && !isNaN(parsed.maxRating) ? parsed.maxRating : parsed.rating5;
          parsed.rating10 = parsed.rating5; // 初期値として5試合制のレートを引き継ぐ
        ...
        if (typeof parsed.rating5 !== 'number' || isNaN(parsed.rating5)) parsed.rating5 = 500;
        if (typeof parsed.maxRating5 !== 'number' || isNaN(parsed.maxRating5)) parsed.maxRating5 = 500;
        if (typeof parsed.rating10 !== 'number' || isNaN(parsed.rating10)) parsed.rating10 = 500;
        if (typeof parsed.maxRating10 !== 'number' || isNaN(parsed.maxRating10)) parsed.maxRating10 = 500;
  ...
  useEffect(() => {
    ...
    // ★ 放置ペナルティ: 5試合・10試合それぞれのレートから引く
    if (daysPassed >= 5 && (userData.rating5 > 0 || userData.rating10 > 0)) {
      const decayDays = daysPassed - 4;
      const decayAmount = decayDays * 20;
      ...
      setDecayInfo({ 
        days: decayDays, 
        amount: decayAmount, 
        oldRating: userData.rating5, // 代表して5試合制を表示
  ...
  useEffect(() => {
    const rawAiPlayers = [
      { userId: 'ai_player_2', username: 'AI_Beta', rating: 1200, maxRating: 1200, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_3', username: 'AI_Gamma', rating: 1500, maxRating: 1500, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_6', username: 'AI_Zeta', rating: 1300, maxRating: 1300, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_7', username: 'AI_Eta', rating: 1400, maxRating: 1400, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_8', username: 'AI_Theta', rating: 1600, maxRating: 1600, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_10', username: 'AI_Kappa', rating: 1250, maxRating: 1250, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_11', username: 'AI_Lambda', rating: 1450, maxRating: 1450, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_12', username: 'AI_Mu', rating: 1700, maxRating: 1700, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_15', username: 'AI_Omicron', rating: 1350, maxRating: 1350, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_16', username: 'AI_Pi', rating: 1550, maxRating: 1550, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_19', username: 'AI_Tau', rating: 1280, maxRating: 1280, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_20', username: 'AI_Upsilon', rating: 1480, maxRating: 1480, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_22', username: 'AI_Chi', rating: 1220, maxRating: 1220, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_23', username: 'AI_Psi', rating: 1420, maxRating: 1420, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_24', username: 'AI_Omega', rating: 1620, maxRating: 1620, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_27', username: 'AI_Gemini', rating: 1320, maxRating: 1320, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_28', username: 'AI_Cancer', rating: 1520, maxRating: 1520, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_31', username: 'AI_Libra', rating: 1380, maxRating: 1380, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_32', username: 'AI_Scorpio', rating: 1580, maxRating: 1580, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_35', username: 'AI_Aquarius', rating: 1260, maxRating: 1260, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_36', username: 'AI_Pisces', rating: 1460, maxRating: 1460, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_37', username: 'AI_Orion', rating: 1660, maxRating: 1660, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_40', username: 'AI_Draco', rating: 1360, maxRating: 1360, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_41', username: 'AI_Pegasus', rating: 2100, maxRating: 2100, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_42', username: 'AI_Phoenix', rating: 2200, maxRating: 2200, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_54', username: 'AI_Perseus', rating: 1200, maxRating: 1200, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_55', username: 'AI_Ophiuchus', rating: 1300, maxRating: 1300, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_56', username: 'AI_Serpens', rating: 1400, maxRating: 1400, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_57', username: 'AI_Sagitta', rating: 1500, maxRating: 1500, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_58', username: 'AI_Aquila', rating: 1600, maxRating: 1600, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_59', username: 'AI_Delphinus', rating: 1700, maxRating: 1700, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_60', username: 'AI_Equuleus', rating: 1800, maxRating: 1800, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_61', username: 'AI_CanisMajor', rating: 1850, maxRating: 1850, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_62', username: 'AI_CanisMinor', rating: 1900, maxRating: 1900, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_63', username: 'AI_Lepus', rating: 1950, maxRating: 1950, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_64', username: 'AI_Columba', rating: 2000, maxRating: 2000, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_65', username: 'AI_Centaurus2', rating: 2100, maxRating: 2100, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_66', username: 'AI_Crux', rating: 2200, maxRating: 2200, isAIPlayer: true, status: 'online' },
      { userId: 'ai_player_72', username: 'AI_UrsaMajor', rating: 1250, maxRating: 1250, isAIPlayer: true, isSuperAI: true, status: 'online' },
      { userId: 'ai_player_73', username: 'AI_UrsaMinor', rating: 1350, maxRating: 1350, isAIPlayer: true, isSuperAI: true, status: 'online' },
      { userId: 'ai_player_74', username: 'AI_CassiopeiaX', rating: 1450, maxRating: 1450, isAIPlayer: true, isSuperAI: true, status: 'online' },
      { userId: 'ai_player_75', username: 'AI_Cepheus', rating: 1550, maxRating: 1550, isAIPlayer: true, isSuperAI: true, status: 'online' },
      { userId: 'ai_player_76', username: 'AI_Cetus', rating: 1650, maxRating: 1650, isAIPlayer: true, isSuperAI: true, status: 'online' },
      { userId: 'ai_player_77', username: 'AI_Eridanus', rating: 1750, maxRating: 1750, isAIPlayer: true, isSuperAI: true, status: 'online' },
      { userId: 'ai_player_78', username: 'AI_Hydrus', rating: 1850, maxRating: 1850, isAIPlayer: true, isSuperAI: true, status: 'online' },
      { userId: 'ai_player_79', username: 'AI_Lupus', rating: 1950, maxRating: 1950, isAIPlayer: true, isSuperAI: true, status: 'online' },
      { userId: 'ai_player_80', username: 'AI_PegasusX', rating: 2050, maxRating: 2050, isAIPlayer: true, isSuperAI: true, status: 'online' },
      { userId: 'ai_player_81', username: 'AI_asn_v2', rating: 2150, maxRating: 2150, isAIPlayer: true, isSuperAI: true, status: 'online' },
      { userId: 'ai_player_82', username: 'AI_Nova', rating: 1900, maxRating: 1900, isAIPlayer: true, isSuperAI: true, status: 'online' },
      { userId: 'ai_player_83', username: 'AI_Pulsar', rating: 1950, maxRating: 1950, isAIPlayer: true, isSuperAI: true, status: 'online' },
      { userId: 'ai_player_84', username: 'AI_Quasar', rating: 2000, maxRating: 2000, isAIPlayer: true, isSuperAI: true, status: 'online' },
      { userId: 'ai_player_85', username: 'AI_Nebula', rating: 2050, maxRating: 2050, isAIPlayer: true, isSuperAI: true, status: 'online' },
      { userId: 'ai_player_86', username: 'AI_Zenith', rating: 2100, maxRating: 2100, isAIPlayer: true, isSuperAI: true, status: 'online' }
    ];

    // ★ AIデータの初期構造をVer3.2用に整形
    const aiPlayers = rawAiPlayers.map(ai => ({
      ...ai,
      rating5: ai.rating,
      maxRating5: ai.maxRating,
      rating10: ai.rating,
      maxRating10: ai.maxRating,
      stats: {
        rank5: { wins: [0,0,0,0], totalGames: 0, currentWinStreak: 0, maxWinStreak: 0, disconnects: 0 },
        rank10: { wins: [0,0,0,0], totalGames: 0, currentWinStreak: 0, maxWinStreak: 0, disconnects: 0 },
        room: { wins: [0,0,0,0], totalGames: 0, currentWinStreak: 0, maxWinStreak: 0, disconnects: 0 },
        ...
        if (matchCountSim > 0 && !isRestTime) {
           ...
           for (let mCount = 0; mCount < matchCountSim; mCount++) {
              ...
              playersForMatch.sort((a, b) => {
                const aMax = typeof a[maxRatingKey] === 'number' && !isNaN(a[maxRatingKey]) ? a[maxRatingKey] : (a[ratingKey] || 500);
                const bMax = typeof b[maxRatingKey] === 'number' && !isNaN(b[maxRatingKey]) ? b[maxRatingKey] : (b[ratingKey] || 500);
                
                const effA = a.isUltraSuperAI ? (3000 + aMax * 3) : (a.isSuperAI ? 2000 : aMax);
                const effB = b.isUltraSuperAI ? (3000 + bMax * 3) : (b.isSuperAI ? 2000 : bMax);
                return effB - effA + (Math.random() * 800 - 400);
              });
              
              const currentRatings = playersForMatch.map(p => {
                 return typeof p[ratingKey] === 'number' && !isNaN(p[ratingKey]) ? p[ratingKey] : 500;
              });
              ...
              for (let i = 0; i < 4; i++) {
                 if (playersForMatch[i].userId !== 'mob') {
                    ...
                    if (aiTarget) {
                      const safeOldRating = typeof aiTarget[ratingKey] === 'number' && !isNaN(aiTarget[ratingKey]) ? aiTarget[ratingKey] : 500;
                      const change = calcRating(safeOldRating, currentRatings, i, [0,1,2,3]); // 10試合制でも計算式統一
        ...
        try {
          ...
          if (!docSnap.exists()) {
            ...
            if (data.rating !== undefined) {
               data.rating5 = typeof data.rating === 'number' && !isNaN(data.rating) ? data.rating : ai.rating5;
               data.maxRating5 = typeof data.maxRating === 'number' && !isNaN(data.maxRating) ? data.maxRating : ai.maxRating5;
               data.rating10 = data.rating5;
               data.maxRating10 = data.maxRating5;
               data.stats = {
                  rank5: { wins: data.wins || [0,0,0,0], totalGames: data.totalGames || 0, currentWinStreak: data.currentWinStreak || 0, maxWinStreak: data.maxWinStreak || 0 },
                  rank10: { wins: [0,0,0,0], totalGames: 0, currentWinStreak: 0, maxWinStreak: 0 }
               };
               delete data.rating;
               delete data.maxRating;
               delete data.wins;
               delete data.totalGames;
               delete data.currentWinStreak;
               delete data.maxWinStreak;
               changed = true;
            }
            if (typeof data.rating5 !== 'number' || isNaN(data.rating5) || typeof data.rating10 !== 'number' || isNaN(data.rating10)) {
               data.rating5 = ai.rating5; data.maxRating5 = ai.maxRating5;
               data.rating10 = ai.rating10; data.maxRating10 = ai.maxRating10;
               changed = true;
            }
            if (changed) {
  ...
  useEffect(() => {
    ...
    if (penaltyFlag === 'true') {
      setUserData(prev => {
        const newRating5 = Math.floor((prev.rating5 || 500) * 0.9);
        const newRating10 = Math.floor((prev.rating10 || 500) * 0.9);
  ...
  }, [userData.username, userData.hasCompleted163Settings, showRegisterModal, showRecommendModal, showRulesModal, showUpdateModal, showDisconnectPenaltyModal, showAccountPromptModal, showAccountRegisterModal, showLoginModal, decayInfo]);
  ...
  const handleRegister = (e) => {
    ...
    const updated = { ...userData, username: inputUsername.trim(), lastSeenVersion: CURRENT_VERSION, lastLoginAt: Date.now() };
    saveUserData(updated);
    ...
    try {
      ...
      if (loggedInData) {
         ...
         if (loggedInData.rating !== undefined) {
           loggedInData.rating5 = typeof loggedInData.rating === 'number' && !isNaN(loggedInData.rating) ? loggedInData.rating : 500;
    ...
    try {
      ...
      snapshot.forEach(docSnap => {
        ...
        if (data && data.username) {
           // NaN防護
           data.rating5 = typeof data.rating5 === 'number' && !isNaN(data.rating5) ? data.rating5 : 500;
           data.rating10 = typeof data.rating10 === 'number' && !isNaN(data.rating10) ? data.rating10 : 500;
           list.push(data);
        }
      });
  ...
  const startOnlineGameWithCpu = async () => {
    ...
    while (currentPlayers.length < 4) {
      if (roomData.type.startsWith('rank') && availableAIList.length > 0 && !isRestTime) {
        ...
        currentPlayers.push({ userId: ai.userId, name: ai.username, rating: aiRating, maxRating: aiMaxRating || aiRating, isCpu: true, isAIPlayer: true, isSuperAI: ai.isSuperAI || false, isUltraSuperAI: ai.isUltraSuperAI || false });
  ...
  useEffect(() => {
    ...
    if (isCurrentCpuSlot) {
      ...
      const move = findBestCpuMove(cpuHand, field, isReversedEffective, cpuThinkRating, hands, turn, isAIPlayer, isSuperAI, isUltraSuperAI);
  ...
  // ★ Ver3.2 試合終了時に5試合/10試合を分けて戦績・レートを保存
  const finishGameSet = (finalScores) => {
    ...
    if (isRankMatch) {
      if (totalMatches === 10) {
        const safeMyRating = typeof userData.rating10 === 'number' && !isNaN(userData.rating10) ? userData.rating10 : 500;
        ...
        const safeMyRating = typeof userData.rating5 === 'number' && !isNaN(userData.rating5) ? userData.rating5 : 500;
          ...
          if (p && p.isAIPlayer) {
            try {
              ...
              if (aiSnap.exists()) {
                ...
                const safeOldRating = typeof aiData[ratingKey] === 'number' && !isNaN(aiData[ratingKey]) ? aiData[ratingKey] : 500;
                const aiChange = calcRating(safeOldRating, playerRatings, aiRank, playerIndices);
  ...
  const handleConfirmReturnHome = async () => {
    ...
    if (isOnlineMode && roomId && roomData) {
      ...
      if (isRankMatch) {
        if (totalMatches === 10) {
           newRating10 = Math.max(0, userData.rating10 - 15);
        } else {
           newRating5 = Math.max(0, userData.rating5 - 15);
        }
      }
      ...
      usersSnap.forEach(d => {
        ...
        if (d.id !== userData.userId && data.username.includes(searchFriendQuery)) {
          if (!friendsList.some(f => f.userId === d.id)) {
            res.push({ userId: d.id, username: data.username, rating5: data.rating5 || 500 });
          }
        }
      });
        ...
        <div className="modal-overlay" style={{ zIndex: 10000 }}>
          <div className="modal-content">
            ...
            <p style={{ fontSize: '13px', lineHeight: '1.5', textAlign: 'left' }}>
              <strong>{decayInfo.days + 4}日間</strong> ログインがなかったため、ペナルティとしてレーティングが減少しました。<br/><br/>
                      ...
                      <div key={f.userId} className="friend-list-item">
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                          ...
                          <span style={{
                            ...
                            backgroundColor: getStatusColor(f), marginLeft: '6px', boxShadow: `0 0 4px ${getStatusColor(f)}`
                          }} title={getStatusText(f)}></span>
                          <span style={{ fontSize: '11px', color: '#7f8c8d', marginLeft: '10px' }}>({f.rating5 || 500} Pt)</span>
                        </div>
                ...
                <div className="rules-scroll-area" style={{ maxHeight: '50vh' }}>
                  {searchFriendResults.map(u => (
                    <div key={u.userId} className="friend-list-item">
                      <div>
                        <strong>{u.username}</strong> <span style={{ fontSize: '11px', color: '#7f8c8d' }}>({u.rating5} Pt)</span>
                      </div>
              ...
              <div className="rules-scroll-area" style={{ maxHeight: '60vh' }}>
                {friendRequestsList.length === 0 ? (
                  ...
                  friendRequestsList.map(f => (
                    <div key={f.userId} className="friend-list-item">
                      <div>
                        <strong>{f.username}</strong> <span style={{ fontSize: '11px', color: '#7f8c8d' }}>({f.rating5 || 500} Pt)</span>
                      </div>
                      <div className="friend-actions">
