...
function App() {
  ...
  useEffect(() => {
    const runAISimulation = async () => {
      const aiIds = [
        'ai_player_1', 'ai_player_2', 'ai_player_3', 'ai_player_4', 'ai_player_5',
        'ai_player_6', 'ai_player_7', 'ai_player_8', 'ai_player_9', 'ai_player_10',
        'ai_player_11', 'ai_player_12', 'ai_player_13', 'ai_player_14', 'ai_player_15',
        'ai_player_16', 'ai_player_17', 'ai_player_18', 'ai_player_19', 'ai_player_20'
      ];
      const aiData = [];
